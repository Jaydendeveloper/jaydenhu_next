                    ...
                    <h4 className='absolute py-4 left-4 text-xl outline-none'>
                        <Link href={'/'}>
                            <a className='outline-none'>
                                <font className="text-[#38b4c8]">&lt;</font> Jayden.hu /<font className="text-[#38b4c8]">&gt;</font>
                            </a>
                        </Link>
                    </h4>
                    <button className='absolute right-4 outline-none'>
                        <div className='p-1'>
                            <a className='p-1'>
                                {
                                !user && 
                                <Link href={'/login'}><div className="border-2 border-[#38b4c8] outline-none pop-out rounded-md p-2">Log in</div></Link>
                                }
                                {
                                user &&
                                ...
                                loading && 
                                <div>
                                    <svg role="status" className="inline w-10 h-10 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-[#38b4c8]" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
