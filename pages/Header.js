                ...
                <button className='absolute right-4 outline-none'>
                    <div className='p-1'>
                        <a className='p-1'>
                            ...
                            loading && 
                            <div>
                                <svg role="status" className="inline w-10 h-10 text-gray-200 animate-spin dark:text-gray-600 fill-[#38b4c8]" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
